...
if not SECRET_KEY:
    raise RuntimeError('DJANGO_SECRET_KEY is not set in environment or .env')
...
AUTHENTICATION_BACKENDS = [
    'users.backends.EmailOrPhoneBackend',           # вход по телефону или email
...
# Указываем папку со статикой в корне проекта
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
